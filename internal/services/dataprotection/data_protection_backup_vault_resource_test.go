...
func TestAccDataProtectionBackupVault_updateToUserAssignedIdentity(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_data_protection_backup_vault", "test")
	r := DataProtectionBackupVaultResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func TestAccDataProtectionBackupVault_updateUserAssignedIdentity(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_data_protection_backup_vault", "test")
	r := DataProtectionBackupVaultResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
		...
		data.ImportStep(),
		{
			Config: r.updateUserAssignedIdentity(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccDataProtectionBackupVault_removeCmk(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_data_protection_backup_vault", "test")
	r := DataProtectionBackupVaultResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func (r DataProtectionBackupVaultResource) updateUserAssignedIdentity(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r DataProtectionBackupVaultResource) removeCmk(data acceptance.TestData) string {
	template := r.updateIdentityToSystemAssigned(data)
	return fmt.Sprintf(`
%s
