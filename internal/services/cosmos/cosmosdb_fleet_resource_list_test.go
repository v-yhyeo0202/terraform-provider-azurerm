...
func TestAccCosmosdbFleet_list_basic(t *testing.T) {
	...
	const listResourceAddress = "azurerm_cosmosdb_fleet.list"
...
resource "azurerm_cosmosdb_fleet" "test" {
  ...
  name                = "acctestfleet${count.index}%d"
...
func (r CosmosdbFleetResource) basicQuery() string {
	return `
...
func (r CosmosdbFleetResource) basicQueryByResourceGroupName(data acceptance.TestData) string {
	return `
list "azurerm_cosmosdb_fleet" "list" {
  provider = azurerm
  config {
