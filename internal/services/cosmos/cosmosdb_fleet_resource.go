...
type CosmosDbFleetResourceModel struct {
...
func (r CosmosDbFleetResource) ModelObject() interface{} {
	return &CosmosDbFleetResourceModel{}
}
...
func (r CosmosDbFleetResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			var model CosmosDbFleetResourceModel
			...
			if _, err := client.FleetCreate(ctx, id, payload); err != nil {
...
func (r CosmosDbFleetResource) flatten(metadata sdk.ResourceMetaData, id *fleets.FleetId, model *fleets.FleetResource) error {
	state := CosmosDbFleetResourceModel{
		Name:              id.FleetName,
