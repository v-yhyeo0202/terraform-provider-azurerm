...
* `name` - (Required) The name which should be used for this Cosmos DB Fleet. Changing this forces a new resource to be created.
...
* `tags` - (Optional) A mapping of tags which should be assigned to the Cosmos DB Fleet. Changing this forces a new resource to be created.
